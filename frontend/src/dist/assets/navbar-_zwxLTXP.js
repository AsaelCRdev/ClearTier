import{n as e,t}from"./tokenStorage-CrOxvkFu.js";function n(){let t=e();if(!t)throw window.location.href=`/src/pages/login.html`,Error(`No autenticado`);return t}var r=[{key:`dashboard`,label:`Dashboard`,icon:`bi-grid-1x2-fill`,href:`/src/pages/dashboard.html`},{key:`users`,label:`Users`,icon:`bi-people-fill`,href:`/src/pages/users/users.html`},{key:`roles`,label:`Roles`,icon:`bi-key-fill`,href:`/src/pages/roles/roles.html`},{key:`permissions`,label:`Permissions`,icon:`bi-shield-lock-fill`,href:`/src/pages/permissions/permissions.html`},{key:`audit`,label:`Audit Log`,icon:`bi-clock-history`,href:`/src/pages/audit/audit.html`}],i={key:`ai-assistant`,label:`AI Assistant`,icon:`bi-robot`,href:`/src/pages/ai-assistant/ai-assistant.html`};function a(e,t){let n=document.getElementById(e);if(!n)return;let a=e=>`
