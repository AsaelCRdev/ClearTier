import"./tokenStorage-CrOxvkFu.js";import{n as e,r as t,t as n}from"./navbar-_zwxLTXP.js";import{n as r,r as i,t as a}from"./roleApi-Db8IHcct.js";import{t as o}from"./toast-wPD29RCn.js";import{n as s}from"./validators-eXC2fl6a.js";import{t as c}from"./modal-9Ha9NeQJ.js";var l=t();e(`sidebar-root`,`roles`),n(`navbar-root`,{userInitial:l.userFullName.charAt(0),hasNotifications:!0});var u=document.getElementById(`roles-grid`),d=document.getElementById(`create-role-btn`),f=new Set;function p(e){let t=f.has(e.id);return e.isSystemRole?`
      <div class="col-md-4">
